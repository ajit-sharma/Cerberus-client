  ...
  private void openLog(boolean init) {
    ...
    try {
      //String logFilename = context.getFileStreamPath(
       //                 "/sdcard/PowerTrace.log").getAbsolutePath();
      String logFilename = "/sdcard/PowerTrace.log";
      ...
      Log.e(TAG, "FILENAME is "+ logFilename);
    } catch(IOException e) {
      logStream = null;
...
//                               "/sdcard/PowerTrace.log").getAbsolutePath());
//            
            logUploader.upload("/sdcard/PowerTrace.log");
