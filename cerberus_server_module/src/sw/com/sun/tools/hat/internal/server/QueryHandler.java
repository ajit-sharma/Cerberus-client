...
abstract class QueryHandler {
    ...
    protected Map<String,HistoObject> befHisto;
    protected UserPkgMain usrpkgmain= new UserPkgMain();
    protected UserPkg usrpkg = new UserPkg();
    protected ArrayList<AllInstance> instance_list = new ArrayList<AllInstance>();
    protected ArrayList<RefObject> reference_list = new ArrayList<RefObject>();
    protected ArrayList<String> reference_list_id = new ArrayList<String>();
    protected ArrayList<String> reference_list_id_chk = new ArrayList<String>();
    
    protected long sumedInstance;
    protected long sumedSize = 1;
...
//    }
	...
	long getSumedSize()
	{
		return this.sumedSize;
	}
	void setSumedSize(long _size)
	{
		this.sumedSize = _size;
	}
	...
	ArrayList<AllInstance> getInstanceList()
	{
	...
	public void setbefHisto(Map<String, HistoObject> befHistomap) {
		this.befHisto = befHistomap;
		
	}
	void initbefHisto(){
    	this.befHisto = new HashMap<String, HistoObject>();
    }
    
    Map<String, HistoObject> getbefHisto(){
    	return this.befHisto;
    }
